...
function spacexchimp_p004_register_submenu_page() {
    $menu_title = SPACEXCHIMP_P004_NAME;
    $capability = 'manage_options';
    add_options_page( SPACEXCHIMP_P004_NAME, $menu_title, $capability, SPACEXCHIMP_P004_SLUG, 'spacexchimp_p004_render_submenu_page' );
}
